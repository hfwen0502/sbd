...
mpirun -x PATH -x LD_LIBRARY_PATH -x MIYABI -n 16 ./diag --fcidump fcidump_Fe4S4.txt --adetfile AlphaDets.bin --method 0 --block 10 --iteration 1 --tolerance 1.0e-4 --eps 1.0e-4 --adet_comm_size 2 --bdet_comm_size 2 --task_comm_size 4 --init 0 --shuffle 0 --carryover_ratio 0.5 --savename wf --carryoverfile carryover.txt --rdm 0 --max_time 24000
