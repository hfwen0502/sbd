...
# Build include/library directories. C++ headers are embedded at the
# repo root (this branch carries local C++ patches on top of the upstream
# snapshot, so it does not use the vendor/sbd-upstream submodule layout
# that main does).
